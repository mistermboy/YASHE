let Shape =require( '../shexEntities/shape');
let Triple =require( '../shexEntities/triple');
let TypesFactory =require( '../shexEntities/types/typesFactory');
let CardinalityFactory =require( '../shexEntities/others/cardinality/cardinalityFactory');
let Facet =require( '../shexEntities/others/facet');
let PrefixedIri =require( '../shexEntities/types/concreteTypes/prefixedIri');
let IriRef =require( '../shexEntities/types/concreteTypes/iriRef');
let BNode =require( '../shexEntities/types/concreteTypes/bNode');
let Primitive =require( '../shexEntities/types/concreteTypes/primitive');
let ValueSet =require( '../shexEntities/types/concreteTypes/valueSet');
let Literal =require( '../shexEntities/types/concreteTypes/kinds/literal');
let NonLiteral =require( '../shexEntities/types/concreteTypes/kinds/nonLiteral');
let IriKind =require( '../shexEntities/types/concreteTypes/kinds/iriKind');
let BNodeKind =require( '../shexEntities/types/concreteTypes/kinds/bNodeKind');
let BlankKind =require( '../shexEntities/types/concreteTypes/kinds/blankKind');
let NumberLiteral =require( '../shexEntities/types/concreteTypes/literal/numberLiteral');
let StringLiteral =require( '../shexEntities/types/concreteTypes/literal/stringLiteral');
let BooleanLiteral =require( '../shexEntities/types/concreteTypes/literal/booleanLiteral');
let Prefix =require( '../shexEntities/others/prefix');
    ...
    for(let i=0;i<tokens.length;i++){
        ...
        if(token.type == 'valueSet'){
            if(token.string.startsWith('@')){// LANTAG NOT SUPPORTED AT THE MOMENT
                Codemirror.signal(editor,'forceError','LANTAG_ERR');
            }else{
...
function getPrefixValue(prefixName){
    let defPrefixes = editor.getDefinedPrefixes();
